...
TRAIN_ROOT = "/content/argoverse1/train/data"

VAL_ROOT = "/content/argoverse1/val/data"

TEST_ROOT = "/content/argoverse1/test/data"

MAP_ROOT = "/content/argoverse1/hd_maps/map_files"

CHECKPOINT_ROOT = Path(
    "/content/drive/MyDrive/DSTNet/checkpoints/gpu_training"
)

LOG_ROOT = Path(
    "/content/drive/MyDrive/DSTNet/logs"
)

RESULTS_ROOT = Path(
    "/content/drive/MyDrive/DSTNet/results"
)

CACHE_ROOT = Path(
    "/content/drive/MyDrive/DSTNet/cache"
)
